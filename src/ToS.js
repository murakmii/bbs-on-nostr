  ...
  return (
    <div id="ToS">
      ...
      <ul>
        ...
        <li>
          本サイトは<a href="https://snort.social/p/npub1rpqr4ygerl4357lsn02c8cm8qq4tv55tapnmmnslld37prkcprzs0flhga" target="_blank" rel="noreferrer">murakmii</a>(以下、開発者)が実験的に公開しているサイトです。
          そのため、都合により断りなく停止、非公開化を行う場合があります
        </li>
        <li>
          本サイトはデータを<a href="https://github.com/nostr-protocol/nostr" target="_blank" rel="noreferrer">Nostr</a>に登録します。
